namespace QuanLyCafePOS.UI.Controls
{
    partial class CustomerControl
    {
        ...
        private void InitializeComponent()
        {
            ...
            for (int i = 2; i < 7; i++) this.formLayout.RowStyles.Add(new System.Windows.Forms.RowStyle(System.Windows.Forms.SizeType.Absolute, 36F));
            ...
            this.lblSelected.Text = "Chưa chọn khách hàng";
            ...
            System.Windows.Forms.Label[] labels = new System.Windows.Forms.Label[] { lblName, lblPhone, lblNote, lblSearch };
            ...
            this.formLayout.Controls.Add(this.lblName, 0, 2); this.formLayout.Controls.Add(this.txtName, 1, 2);
            this.formLayout.Controls.Add(this.lblPhone, 0, 3); this.formLayout.Controls.Add(this.txtPhone, 1, 3);
            this.formLayout.Controls.Add(this.lblNote, 0, 4); this.formLayout.Controls.Add(this.txtNote, 1, 4);
            this.formLayout.Controls.Add(this.lblSearch, 0, 5); this.formLayout.Controls.Add(this.txtSearch, 1, 5);
            // buttons
            ...
            this.formLayout.Controls.Add(this.btnAdd, 0, 7); this.formLayout.Controls.Add(this.btnUpdate, 1, 7);
            this.formLayout.Controls.Add(this.btnDelete, 0, 8); this.formLayout.Controls.Add(this.btnReload, 1, 8);
            this.formLayout.Controls.Add(this.btnClear, 0, 9); this.formLayout.SetColumnSpan(this.btnClear, 2);
            // grid
